...
function LatestNews() {
    return(
        <div className="flex flex-col items-center justify-center w-full bg-white mt-10">
            <div className="flex justify-start items-start w-screen h-auto">
                <h2 className="text-5xl font-bold text-left px-20">
                    Latest News
                </h2>
            </div>
                        ...
                        <SwiperSlide>
                            <div className='group block relative cursor-pointer h-full w-full'>
                                    <img
                                        ...
                                        alt="image slide 1"
                                    />
                                    <div className="absolute bottom-0 h-1/2 w-full bg-gradient-to-t from-birumud ">
                                    </div>
